...
public class Level2UI : MonoBehaviour
{
    ...
    {
        Player.GetComponent<Level2PlayerMovement>().MovePillar();
    }
    ...
    {
        Player.GetComponent<Level2PlayerMovement>().FlowerWater();
    }
    ...
    public void ElementSwitchtoFire()
    {
    ...
    {
        SceneManager.LoadScene("VisualNovelLevelTwo");
    }
}